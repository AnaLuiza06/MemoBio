...
<html>
  ...
  <body>
    <header>
      ...
      <button><a href="./cods/pagLogin.html">Login</a></button>
    </header>
    ...
    <main>
      <section id="inicio">
        ...
        <div class="text">
          <h1>Aprenda os conceitos de Biologia de uma vez por todas!!</h1>
          <h3>
            Veja se você realmente sabe a matéria através de perguntas. Se
            errar, tente de novo!
          </h3>
          <div>
            <button><a href="./cods/pagCadastro.html">Cadastre-se</a></button>
          </div>
        </div>
      </section>
        ...
        <div class="assuntos">
          <div class="assuntosItem">
            ...
            <div>
              ...
              <p>
                Um dos assuntos mais cobrados nas provas, a Ecologia é
                responsável por estudas os seres vivos e como eles enteragem no
                ambiente que estão, e entre si.
              </p>
            </div>
          </div>
          <div class="assuntosItem">
      ...
      <section id="sobreOMemo">
        ...
        <div class="container">
          ...
          <div class="cardContainer">
            ...
            <div class="card">
              ...
              <p>
                ...
                da disciplina, de modo a direcionar seu foco para o que precisa
                ser melhorado.
              </p>
            </div>
          </div>
          <div class="cardContainer">
            <div class="sombra"></div>
            <div class="card">
              <h2>Monte Listas Personalizadas</h2>
              <p>
                Além das listas já existentes sobre cada tópico, monte suas
                listas personalizadas com o que realmente precisa estudar.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="depoimentos">
        <h1>O que falam sobre o Memo</h1>
