...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300&family=Prompt:wght@100;200&display=swap" rel="stylesheet" />
	...
	<main>
		<section id="inicio">
			...
			<div class="text">
				...
				<h1>Embarque nessa viagem com a gente!!!</h1>

				<button><a href="./cods/pagCadastro.php">Cadastre-se</a></button>
			</div>
	...
	<footer>
		<div class="footer">
			<div>
				<img src="" />
				<p>
					O MemoBio é uma plataforma de Biologia, com centenas de perguntas
					sobre os assuntos mais abordados nos principais vestibulares.
				</p>
			</div>
